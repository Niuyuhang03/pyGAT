...
# Load data
# 加载数据
adj, features, labels, labels_one_hot, idx_train, idx_val, idx_test = load_data(path="./data/FB15K237/", dataset="FB15K237")
# Model and optimizer
if args.sparse:
...
def compute_test():
    ...
    loss_fn = torch.nn.BCEWithLogitsLoss(reduce=True, size_average=True)
    loss_test = torch.nn(output[idx_test], labels_one_hot[idx_test])
